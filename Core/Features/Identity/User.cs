...
public class User(string emailAddress, string registerIP,
        Enums.AuthenticationTypeEnum registerType) : ExtendedEntity
{
    #region Properties
    ...
    [System.ComponentModel.DataAnnotations.MaxLength
        (length: Constants.MaxLength.NationalCode,
        ErrorMessageResourceType = typeof(Resources.Messages.Validations),
        ErrorMessageResourceName = nameof(Resources.Messages.Validations.MaxLength))]
    ...
    #region public string? TelNumber { get; set; }
    /// <summary>
    /// شماره تلفن ثابت
    /// </summary>
    [System.ComponentModel.DataAnnotations.Display
        (ResourceType = typeof(Resources.DataDictionary),
        Name = nameof(Resources.DataDictionary.TelNumber))]
    ...
    [System.ComponentModel.DataAnnotations.RegularExpression
        (pattern: Constants.RegularExpression.PhoneNumber,
        ErrorMessageResourceType = typeof(Resources.Messages.Validations),
        ErrorMessageResourceName = nameof(Resources.Messages.Validations.CellPhoneNumber))]
    public string? TelNumber { get; set; }
    #endregion /public string? TelNumber { get; set; }
    ...
    [System.ComponentModel.DataAnnotations.MinLength
        (length: Constants.MaxLength.DatabasePassword,
        ErrorMessageResourceType = typeof(Resources.Messages.Validations),
        ErrorMessageResourceName = nameof(Resources.Messages.Validations.MaxLength))]
    ...
    public void SetPassword(string? password)
    {
        ...
        {
            var passwordHash = Faraz.Security
                .Hashing.GetSha256(value: password);

            Password = passwordHash;

            LastChangePasswordDateTime = Faraz.DateTime.Now;
        }
    }
