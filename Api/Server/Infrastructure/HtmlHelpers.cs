...
public static class HtmlHelpers : object
{
        ...
        (this Microsoft.AspNetCore.Mvc.Rendering.IHtmlHelper html, string? value)
    {
        ...
        {
            return html.Raw
                (value: oc.TSB.Core.Constants.Format.NullValue);
        }
        ...
        (this Microsoft.AspNetCore.Mvc.Rendering.IHtmlHelper html, long? value)
    {
        ...
        var result =
            ...
            (format: oc.TSB.Core.Constants.Format.Integer);
        ...
        (this Microsoft.AspNetCore.Mvc.Rendering.IHtmlHelper html, System.DateTime? value)
    {
        ...
        var result =
            value.Value.ToString
            (format: oc.TSB.Core.Constants.Format.DateTime);
        ...
        (this Microsoft.AspNetCore.Mvc.Rendering.IHtmlHelper html, System.DateTimeOffset? value)
    {
        ...
        var result =
            value.Value.ToString
            (format: oc.TSB.Core.Constants.Format.Date);
        ...
        (this Microsoft.AspNetCore.Mvc.Rendering.IHtmlHelper html)
    {
        ...
        span.InnerHtml.Append(unencoded:oc.TSB.Resources.ButtonCaptions.BackToList);
        span.InnerHtml.Append(unencoded: " ");
        span.InnerHtml.Append(unencoded: "]");
        ...
        (this Microsoft.AspNetCore.Mvc.Rendering.IHtmlHelper html)
    {
        ...
        span.InnerHtml.Append(unencoded: " ");
        span.InnerHtml.AppendHtml(content: icon);
        span.InnerHtml.Append(unencoded: oc.TSB.Resources.ButtonCaptions.Details);
        span.InnerHtml.Append(unencoded: " ");
        span.InnerHtml.Append(unencoded: "]");
        ...
        (this Microsoft.AspNetCore.Mvc.Rendering.IHtmlHelper html)
    {
        ...
        //span.InnerHtml.Append(unencoded: " ");
        span.InnerHtml.AppendHtml(content: icon);
        span.InnerHtml.Append(unencoded: oc.TSB.Resources.ButtonCaptions.Create);
        //span.InnerHtml.Append(unencoded: " ");
        //span.InnerHtml.Append(unencoded: "]");
        ...
        (this Microsoft.AspNetCore.Mvc.Rendering.IHtmlHelper html)
    {
        ...
        span.InnerHtml.Append(unencoded: " ");
        span.InnerHtml.AppendHtml(content: icon);
        span.InnerHtml.Append(unencoded:oc.TSB.Resources.ButtonCaptions.Update);
        span.InnerHtml.Append(unencoded: " ");
        span.InnerHtml.Append(unencoded: "]");
        ...
        (this Microsoft.AspNetCore.Mvc.Rendering.IHtmlHelper html)
    {
        ...
        span.InnerHtml.Append(unencoded: " ");
        span.InnerHtml.AppendHtml(content: icon);
        span.InnerHtml.Append(unencoded:oc.TSB.Resources.ButtonCaptions.UpdateInformationsAgain);
        span.InnerHtml.Append(unencoded: " ");
        span.InnerHtml.Append(unencoded: "]");
        ...
        (this Microsoft.AspNetCore.Mvc.Rendering.IHtmlHelper html)
    {
        ...
        span.InnerHtml.Append(unencoded: " ");
        span.InnerHtml.AppendHtml(content: icon);
        span.InnerHtml.Append(unencoded: oc.TSB.Resources.ButtonCaptions.Delete);
        span.InnerHtml.Append(unencoded: " ");
        span.InnerHtml.Append(unencoded: "]");
        ...
        (this Microsoft.AspNetCore.Mvc.Rendering.IHtmlHelper html, int? selectedValue = null) where TEnum : struct
    {
        ...
        var emptySelectListItem =
            ...
            (text:oc.TSB. Resources.DataDictionary.SelectAnItem, value: string.Empty);
